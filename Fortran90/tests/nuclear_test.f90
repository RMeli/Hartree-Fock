...
PROGRAM nuclear_test
    ...
    REAL*8, dimension(K_H2,K_H2) :: Vn1_H2 ! Nucleus-electron interaction matrix
    REAL*8, dimension(K_H2,K_H2) :: Vn2_H2 ! Nucleus-electron interaction matrix
    ...
    REAL*8, dimension(K_H2O,K_H2O) :: Vn1_H2O   ! Nucleus-electron interaction matrix
    REAL*8, dimension(K_H2O,K_H2O) :: Vn2_H2O   ! Nucleus-electron interaction matrix
    REAL*8, dimension(K_H2O,K_H2O) :: Vn3_H2O   ! Nucleus-electron interaction matrix
    ...
    CALL V_nuclear(K_H2,basis_D_H2,basis_A_H2,basis_L_H2,basis_R_H2,Vn1_H2,R_H2(1,1:3),Zn_H2(1))

    WRITE(*,*) "Nuclear matrix V1:"
    CALL print_real_matrix(K_H2,K_H2,Vn1_H2)

    CALL V_nuclear(K_H2,basis_D_H2,basis_A_H2,basis_L_H2,basis_R_H2,Vn2_H2,R_H2(2,1:3),Zn_H2(2))

    WRITE(*,*) "Nuclear matrix V2:"
    CALL print_real_matrix(K_H2,K_H2,Vn2_H2)
    ...
    CALL V_nuclear(K_HeH,basis_D_HeH,basis_A_HeH,basis_L_HeH,basis_R_HeH,Vn1_HeH,R_HeH(1,1:3),Zn_HeH(1))
    ...
    CALL V_nuclear(K_H2O,basis_D_H2O,basis_A_H2O,basis_L_H2O,basis_R_H2O,Vn1_H2O,R_H2O(1,1:3),Zn_H2O(1))
